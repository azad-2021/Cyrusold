...
<form method="POST" action="">
    ...
    <div class="form-group col-md-3">
     ...
     <select class="form-control" name="GadgetID" required onchange="yesnoCheck(this);">
    ...
    <div class="form-group col-md-3">
      ...
      <select class="form-control" name="categoryZ2M1">
        <option value="">Select</option>
      ...
      <select class="form-control" name="categoryZ2M2">
        <option value="">Select</option>
        <option value="Alarm">Alarm</option>
        <option value="Fire Alarm">Fire Alarm</option>
      </select>
...
<div class="form-group col-md-12" id="2"  style="display: none;">
     ...
     <select class="form-control" name="categoryZ4M1">
      <option value="">Select</option>
      <option value="Alarm">Alarm</option>
      <option value="Fire Alarm">Fire Alarm</option>
    </select>
    ...
    <div class="form-group col-md-2">
     ...
     <select class="form-control" name="categoryZ4M2">
      <option value="">Select</option>
      <option value="Alarm">Alarm</option>
      <option value="Fire Alarm">Fire Alarm</option>
    </select>
    ...
    <div class="form-group col-md-2">
     ...
     <select class="form-control" name="categoryZ4M3">
      <option value="">Select</option>
      <option value="Alarm">Alarm</option>
      <option value="Fire Alarm">Fire Alarm</option>
    </select>
    ...
    <div class="form-group col-md-3">
     ...
     <select class="form-control" name="categoryZ4M4">
      <option value="">Select</option>
      <option value="Alarm">Alarm</option>
      <option value="Fire Alarm">Fire Alarm</option>
    </select>
...
<br>
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" cols="12" rows="4" name="Remark"></textarea>
    </div>
