      ...
      <fieldset >
        ...
        <div class="col-lg-12" align="center">
            <form method="post" action="" class="form-inline">
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
              <select  required name="EmployeeCode" class="form-control select" id="exampleFormControlSelect2" >
                <?php
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="submit"  class=" btn btn-success button" value="Add" name="Addtech"></input>
            </form>
          </div>  
