...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #E0E1DE;" id="nav">
  <div class="container-fluid" align="center">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown" align="center">
      ...
      <li class="nav-item">
        <a class="nav-link" hidden="" href="logout.php">Logout</a>
      </li>
      </ul>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <form name="fileUpload" action = "" method = "POST" enctype = "multipart/form-data">
        <div class="row">
          ...
          <div class="col-lg-10">
            <input type="text" class="form-control" name="jobcard" style="text-transform:uppercase"  id="txtInput" onkeypress="return checkSpcialChar(event)">

          </div>
          
          <legend class="legendCard">Upload Job Card File</legend>
          <input id="formFile" class="upload" type = "file" name = "image" />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <br>
          <center>
            ...
            <div class="col-lg-8">
            <select class="form-control" id="exampleFormControlSelect2" name="GadgetID">
              <?php
            ...
            <br>
            <input name="submit" class="btn btn-lg btn-success" value="Submit" type = "submit"/> 
          </center>
          <br>
        </div>
      </form>
