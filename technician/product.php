    ...
    <div class="container">
      <fieldset >        
          <form method="post" action="">
            ...
            <select  required name="RateID" class="form-control select" id="exampleFormControlSelect2" >
              <?php
            ...
            <input type="number" required class="form-control" name="qty" id="qt" maxlength="5" id="txtInput" onkeypress="return checkSpcialChar(event)" onkeydown="limit(this);" onkeyup="limit(this);">
            ...
            <select name="as" id="as" id="exampleFormControlSelect2" class="form-control">
              ...
              <center>
            <input type="submit" style="margin-bottom: 20px;" class=" btn btn-success" value="Add" name="Add"></input>
            </center>            
