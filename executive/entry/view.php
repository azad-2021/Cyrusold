...
$query ="SELECT * FROM `jobcardmain` WHERE ServiceDone is not null and VisitDate>'$Date' and GadgetID != 0 order by VisitDate desc";
...
<html>  
  ...
  <body> 
    ...
    ?>
    <div class="container">
        <table id="example" class=" table row-border table-hover table-dark table-bordered border-primary" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">Service Done</th>
                    <th style="text-align:center">Pending Work</th>
                </tr>
            </thead>
            <tbody>
                <?php  
                while ($row=mysqli_fetch_array($results,MYSQLI_ASSOC)){
                    ...
                    $ServiceDone=$row["ServiceDone"];
                    $Pending=$row["WorkPending"];
                    ...
                    echo '  
                           <tr> 
                                ...
                                <td style="text-align:center">'.$ServiceDone.'</td> 
