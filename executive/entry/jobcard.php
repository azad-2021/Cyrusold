...
if ($con->query($sql) === TRUE) {
  ...
  echo "Error updating record: " . $con->error;
    ...
    if ($link=='CCTV') {
        ...
        $sql2 = "INSERT INTO jobcardcctv (`Card Number`, `CCTVMake`, $Model, CamerNumber, RecordingFrom, RecordingUpto, NoRecording, HDDTotal, HDDAllocated, OpeningCleaning, CheckingPowerSupply)
        VALUES ('$JOBCARD', '$DVR', '1', '$Camera', '$FDate', '$LDate', '$NoRecording', '$THDD', '$AHDD', '$DVR', '$PowerSupply')";


        $sql4 = "INSERT INTO jobcardcctv2 (`Card Number`, `CCTVMake`, $Model, CamerNumber, RecordingFrom, RecordingUpto, NoRecording, HDDTotal, HDDAllocated, OpeningCleaning, CheckingPowerSupply)
        VALUES ('$JOBCARD', '$DVR', '1', '$Camera', '$FDate', '$LDate', '$NoRecording', '$THDD', '$AHDD', '$DVR', '$PowerSupply')";
        ...
        $sql3 = "INSERT INTO jobcardcctv1 (`Card Number`)
        VALUES ('$JOBCARD')";
                        ...
                        <form class="needs-validation form-control novalidate" method="POST">
                            <div class="row g-3">
                                <div class="col-sm-4 div">
                                    ...
                                    <input type="time" class="form-control" placeholder="" name="Arrival" required>
                                ...
                                <div class="col-sm-4 div">
                                    ...
                                    <input type="time" class="form-control" placeholder="" name="Departure" required>
                                </div>
                                <div class="col-sm-4 div">
                                    <label for="Verified By" class="form-label">Verified By</label>
                                    <input type="text" class="form-control" placeholder="" name="VerifiedBy" required>
                                </div>
                                <div class="col-sm-6 div">
                                    <label for="Service Done" class="form-label">Service Done</label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="ServiceDone" required></textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-sm-6 div">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="PendingWork"></textarea>
                                </div>
                            </div>
                            <center>
                        ...
                        <form class="needs-validation form-control novalidate" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-3 div">
                                    ...
                                    <input type="number" class="form-control" placeholder="" name="THDD" required>
                                </div>
                                <div class="col-sm-3 div">
                                    <label for="Allocated HDD" class="form-label">Allocated HDD</label>
                                    <input type="number" class="form-control" placeholder="" name="AHDD" required>
                                </div>
                                <div class="col-sm-4 div">
                                ...
                                <div class="col-sm-3 div">
                                    ...
                                    <input type="text" class="form-control" placeholder="DVR Make" name="DVRMake" required>
                                </div>
                                <div class="col-sm-3 div">
                                    <label class="form-label" for="Camera Type">Types Of Camera Installed</label>
                                    <input type="number" class="form-control" placeholder="" name="Camera" required>
                                </div>
                                <div class="col-sm-3 div">
                                    <label for="last recording date" class="form-label">Days of No Recording</label>
                                    <input type="number" class="form-control" placeholder="" name="NoRecording" required>
                                </div>
                                <div class="col-sm-3 div">
                                ...
                                <div class="form-check col-sm-3 div">
                                  <input class="form-check-input" type="checkbox" value="1" id="flexCheckDefault" name="DVR">
                                  <label class="form-check-label" for="flexCheckDefault">
                            ...
                            <center>
                                <div class="col-sm-3 div">
                                    ...
                                    <input type="datetime-local" class="form-control" placeholder="" name="FDate" required>
                                </div>
                                <div class="col-sm-3 div">
                                    <label for="last recording date" class="form-label">Last Stored Recording Date</label>
                                    <input type="datetime-local" class="form-control" placeholder="" name="LDate" required>
                                </div>
                                <div class="col-sm-6">
                            <button class="btn btn-primary" type="submit" name="submit">Submit</button>
                        </div>
